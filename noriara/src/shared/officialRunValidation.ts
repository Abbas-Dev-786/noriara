...
export function validateOfficialRunPayload(payload: SubmitRunRequest, options: ValidationOptions = {}): ValidationResult {
...
function isAttemptTelemetryValid(attempt: GestureAttempt, maxDurationMs: number): boolean {
...
export function isOfficialRunSubmissionWindowValid(
  startedAtEpochMs: number,
  nowEpochMs: number,
  maxRunDurationMs: number = MAX_OFFICIAL_RUN_DURATION_MS
): boolean {
